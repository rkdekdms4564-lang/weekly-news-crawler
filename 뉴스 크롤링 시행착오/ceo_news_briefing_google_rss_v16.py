...
# =========================================================
# v16 overrides: global incident dedupe beyond keyword/category limits
...
V6_VERSION = "google_rss_v16_global_incident_dedupe"
...
def v16_is_distinct_followup_stage(stage):
    return stage in {"litigation", "policy_change"}
...
def v16_is_same_global_incident(new_item, old_item):
    ...
    new_stage = new_key.split(":")[-1]
    old_stage = old_key.split(":")[-1]
    # 소송/제도개선처럼 다른 단계는 살린다. 단, 같은 단계면 중복.
