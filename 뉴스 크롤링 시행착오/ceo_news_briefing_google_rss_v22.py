...
1. 카카오 및 계열사 이슈는 최우선으로 봐. 특히 경영진·임원 이동, 조직개편, 서비스 개편 논란, 노사/임단협/파업, 소송·수사·과징금·개인정보·장애·피싱·지배구조·실적·매각·투자회수는 높게 평가해.
2. 예를 들어 '[단독] 카톡 개편 논란 관련 임원/CPO 퇴사', '민주노총·노동부 진정·최저임금법 위반', '카카오모빌리티 노무/규제 리스크'는 제목이 자극적이지 않아도 CEO 브리핑 가치가 높아.
3. 정부/국회는 AI, 플랫폼, 디지털자산, 개인정보, 보안, 공정위, 금융위, 금감원, 과기정통부, 방미통위, 온플법, 망사용료, 지도반출, 스테이블코인 등 카카오 사업환경에 영향을 주는 정책·규제 중심으로 골라.
4. 경쟁사/해외이슈는 네이버·구글·오픈AI·MS·메타·애플·쿠팡·토스·배민·통신3사 등 주요 플레이어의 전략, 규제, 소송, 장애, 보안, AI/플랫폼 변화 위주로 골라.
5. 산업동향은 카카오가 직접 주체는 아니지만 AI agent, 플랫폼, 콘텐츠, 광고, 커머스, 결제, 개인정보, 보안, 데이터센터, 앱 생태계 등 카카오 사업환경 전반에 영향을 주는 구조적 변화가 있을 때 1개, 많아도 2개만 골라. 단순 인터뷰, 행사, 제품 루머, 개별 범죄사건, 단순 투자·주가·IPO는 제외해. 경쟁사/해외 섹션에 담지 못한 기사라도 특정 기업의 단발성 움직임이 아니라 업계 전반의 방향 변화나 카카오 전략에 참고할 구조적 신호일 때만 산업동향에 포함할 수 있으며, 경쟁사 cap을 우회하는 보조 슬롯으로 쓰지 마.
